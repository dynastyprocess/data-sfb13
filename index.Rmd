---
title: "SFB12 ADP"
description: A simple ADP site for SFB12, by \@\_TanHo
...
```
```{r include = FALSE}
picks_mfl <- data.table::fread("https://github.com/dynastyprocess/data-sfb12/releases/download/data-mfl/draft_picks_mfl.csv") |> 
  mutate(player_id = as.character(player_id))

picks_sleeper <- data.table::fread("https://github.com/dynastyprocess/data-sfb12/releases/download/data-sleeper/draft_picks_sleeper.csv") |> 
  mutate(player_id = as.character(player_id))

timestamp <- readLines("https://github.com/dynastyprocess/data-sfb12/releases/download/data-sleeper/timestamp.txt")
...
picks_mfl_prep <- picks_mfl |> 
  ...
  mutate(mfl_id = player_id,
         league_id = paste0(league_id,"-",division),
